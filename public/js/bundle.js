  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return axios.get("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId));
        case 2:
...
},{"@stripe/stripe-js":"../../node_modules/@stripe/stripe-js/lib/index.mjs"}],"index.js":[function(require,module,exports) {
"use strict";
